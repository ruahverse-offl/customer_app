...
const NOTIFICATIONS_ENABLED_KEY = 'nb_notifications_enabled';
...
export function NotificationProvider({ children }: { children: React.ReactNode }) {
  ...
  const sendLocalTest = useCallback(async () => {
    Alert.alert('Expo Go limitation', EXPO_GO_ANDROID_PUSH_MSG);
  }, []);
  ...
  const value = useMemo(
    ...
    [loading, enabled, setEnabled, refreshToken, sendLocalTest],
  );
